			...
			<div class="sidebar-content">
				...
				<ul class="sidebar-nav">
					<li class="sidebar-item">
						<a class="sidebar-link" href="/KioskParticipant">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="/KP-appForm">
                    ...
                    <li class="sidebar-item">
						<a class="sidebar-link" href="/kpComplaint">
                    ...
                    <li class="sidebar-item">
						<a class="sidebar-link" href="/kpSale">
		...
		<div class="main">
			<ul class="nav justify-content-end">
				<li class="nav-item dropdown ms-lg-2">
					...
					{{-- Yield --}}
					@yield('Application.KioskParticipant.form')
